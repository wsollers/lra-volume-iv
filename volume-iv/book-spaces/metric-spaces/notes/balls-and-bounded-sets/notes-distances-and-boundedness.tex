...
\begin{figure}[htbp]
\centering
\input{volume-iv/book-spaces/metric-spaces/figures/fig-diameter-distance-set}
...
\begin{figure}[htbp]
\centering
\input{volume-iv/book-spaces/metric-spaces/figures/fig-point-set-distance}
...
\begin{figure}[htbp]
\centering
\input{volume-iv/book-spaces/metric-spaces/figures/fig-set-set-distance}
\caption{The set-to-set distance \(d(A,B)\) is the infimum of all distances
between one point of \(A\) and one point of \(B\).}
\label{fig:metric-set-set-distance}
\end{figure}
...
\begin{figure}[htbp]
\centering
\input{volume-iv/book-spaces/metric-spaces/figures/fig-bounded-interval-r}
...
\begin{figure}[htbp]
\centering
\input{volume-iv/book-spaces/metric-spaces/figures/fig-bounded-arbitrary-set}
...
\end{itemize}
\end{dependencies}
\hyperref[prf:metric-equivalent-boundedness-criterion]{\texti
t{Go to proof.}}
