...
\begin{figure}[htbp]
\centering
\input{volume-iv/book-spaces/metric-spaces/figures/fig-sequential-convergence-tail}
\caption{Metric convergence means that for every tolerance around the limit,
there is a tail of the sequence contained inside that tolerance.}
\label{fig:sequential-convergence-tail}
\end{figure}
