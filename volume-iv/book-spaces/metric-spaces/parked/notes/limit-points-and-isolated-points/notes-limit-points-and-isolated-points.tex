...
\begin{figure}[htbp]
\centering
\input{volume-iv/book-spaces/metric-spaces/figures/fig-limit-isolated-points}
\caption{A limit point is approached at every scale by other points of the
set, while an isolated point has a small ball containing no other points of
the set.}
\label{fig:limit-isolated-points}
\end{figure}
