...
\begin{itemize}
  ...
  \item \hyperref[ex:boolean-ring-four-elements]{Example: The four-element Boolean ring $\mathbf{2}^2$}
...
\begin{itemize}
  ...
  \item \hyperref[lem:self-additive-inverse]{Lemma: Self Additive Inverse ($p+p=0$)}
  \item \hyperref[lem:self-negation]{Lemma: Self Negation ($-p=p$)}
\end{itemize}
...
\textbf{Atomic items in this section:}
\begin{itemize}
  \item \hyperref[def:ring-of-sets]{Definition: Ring}
\end{itemize}
...
\input{volume-iv/book-spaces/algebras-of-sets/notes/rings-of-sets/notes-rings-of-sets}
\input{volume-iv/book-spaces/algebras-of-sets/notes/rings-of-sets/notes-boolean-rings}
\input{volume-iv/book-spaces/algebras-of-sets/notes/rings-of-sets/notes-boolean-ring-example}
