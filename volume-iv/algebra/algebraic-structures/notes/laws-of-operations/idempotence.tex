...
\algebraMigrationTODO{idempotence}{the prior working notes did not contain a clearly
isolated idempotence discussion in the legacy Algebraic Structures chapter}
