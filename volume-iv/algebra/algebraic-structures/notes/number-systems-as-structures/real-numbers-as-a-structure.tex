```tex
% =========================================================
% Volume IV  §1.7.?  — R as a Model of the Ordered Field Signature
%
% Light Vol-IV style:
...
\algebraTopicToolkit{$\mathbb{R}$ as a Model of the Ordered Field Signature}{
...
\begin{itemize}
    \item \hyperref[def:field]{Field}.
    \item \hyperref[def:positive-cone]{Positive Cone}.
    \item Volume~II construction of $\mathbb R$.
    \item Ordered-field development in Volume~II.
\end{itemize}
