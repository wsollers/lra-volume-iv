```tex
% =========================================================
% Volume IV  §1.7.?  — C as a Model of the Field Signature
%
% Light Vol-IV style:
...
\algebraTopicToolkit{$\mathbb{C}$ as a Model of the Field Signature}{
...
\begin{itemize}
    ...
    \item Volume~II construction of $\mathbb C$.
