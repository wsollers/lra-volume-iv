```tex
% =========================================================
% Volume IV  §1.7.?  — Z as a Model of the Arithmetic Signature
% Light Vol-IV style:
%   \begin{definition}/\begin{remark*}/\algebraTopicToolkit
%
...
\algebraTopicToolkit{$\mathbb{Z}$ as a Model of the Ring Signature}{
...
\hyperref[def:integer-operations]{integer operations}.
...
\begin{itemize}
    ...
    \item Volume~II construction of $\mathbb Z$.
    \item \hyperref[def:integer-operations]{Integer Operations}.
\end{itemize}
