% =========================================================
% Volume IV  §1.7.?  — N as a Model of the Arithmetic Signature
...
%   def:arithmetic-signature, def:peano-system, def:natural-number-operations,
...
\algebraTopicToolkit{$\mathbb{N}$ as a Model of the Arithmetic Signature}{
...
\hyperref[def:natural-number-operations]{natural-number operations}:
...
\begin{itemize}
  ...
  \item Volume~II: construction of $\mathbb{N}$ and the
        \hyperref[def:natural-number-operations]{natural-number operations}.
\end{itemize}
\end{remark*}
