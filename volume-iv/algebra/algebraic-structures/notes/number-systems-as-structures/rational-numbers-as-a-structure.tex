% =========================================================
% Volume IV  §1.7.5  — Q as a Model of the Field Signature
% Replaces the one-line stub. Light Vol-IV style:
%   \begin{definition}/\begin{remark*}/\algebraTopicToolkit, no tcolorbox.
%
% WIRING NOTE (cross-volume):
%   The \hyperref targets thm:q-is-field, thm:q-is-integral-domain,
%   thm:q-is-ordered-field, def:field, def:rational-operations,
...
\algebraTopicToolkit{$\mathbb{Q}$ as a Model of the Field Signature}{
...
\hyperref[def:rational-operations]{rational operations}: $+^{\mathcal{Q}}$ and
...
\begin{itemize}
  ...
  \item \hyperref[def:field]{Field} (Volume~II).
  \item Volume~II: construction of $\mathbb{Q}$ and the
