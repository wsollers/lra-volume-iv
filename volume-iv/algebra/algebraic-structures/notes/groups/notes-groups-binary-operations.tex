...
\begin{tcolorbox}[title={Definition --- Binary Operation}]
\begin{definition}[Binary Operation]
\label{def:group-binary-operation}
...
\begin{tcolorbox}[title={Definition --- Associativity}]
\begin{definition}[Associativity]
\label{def:group-associativity}
