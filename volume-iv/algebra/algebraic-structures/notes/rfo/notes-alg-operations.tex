...
% TOOLKIT — Operations
% ---------------------------------------------------------
\begin{toolkitbox}{Operations — Quick Reference}
\small
\begin{tabular}{l l l}
\toprule
...
\begin{definitionbox}{Definition (Nullary Operation / Distinguished Element)}
...
\begin{definitionbox}{Definition (Properties of Unary Operations)}
...
\begin{toolkitbox}{Laws of Binary Operations — Quick Reference}
\small
\begin{tabular}{l l l}
\toprule
...
\begin{definitionbox}{Definition (Distributivity)}
...
\begin{definitionbox}{Definition (Cancellation Laws)}
...
\begin{toolkitbox}{Distinguished Elements — Quick Reference}
\small
\begin{tabular}{l l l}
\toprule
...
\begin{definitionbox}{Definition (Identity Element)}
...
\begin{definitionbox}{Definition (Inverse Element)}
...
\begin{definitionbox}{Definition (Compatibility of a Relation with an Operation)}
