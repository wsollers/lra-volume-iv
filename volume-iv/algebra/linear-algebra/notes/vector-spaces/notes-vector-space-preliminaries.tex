...
\begin{tcolorbox}[colback=gray!6, colframe=gray!40, arc=2pt,
  ...
  title={\small\textbf{Toolkit --- Vector Space Preliminaries}},
...
\begin{tcolorbox}[colback=defbox, colframe=defborder, arc=2pt,
  left=6pt, right=6pt, top=4pt, bottom=4pt,
  title={\small\textbf{Definition (List)}},
  fonttitle=\small\bfseries]
...
\smallskip
\noindent
\hyperref[prf:list-equality]{\textit{Go to proof of equality.}}
...
\begin{tcolorbox}[colback=defbox, colframe=defborder, arc=2pt,
  left=6pt, right=6pt, top=4pt, bottom=4pt,
  title={\small\textbf{Definition ($\mathbf{F}^n$)}},
  fonttitle=\small\bfseries]
...
\begin{tcolorbox}[colback=defbox, colframe=defborder, arc=2pt,
  left=6pt, right=6pt, top=4pt, bottom=4pt,
  title={\small\textbf{Definition (Addition in $\mathbf{F}^n$)}},
  fonttitle=\small\bfseries]
...
\begin{tcolorbox}[colback=thmbox, colframe=thmborder, arc=2pt,
  left=6pt, right=6pt, top=4pt, bottom=4pt,
  title={\small\textbf{Theorem (Addition Is Commutative in $\mathbf{F}^n$)}},
  fonttitle=\small\bfseries]
...
x+y=y+x.
\]
\hyperref[prf:addition-commutative-fn]{\textit{Go to proof.}}
\end{theorem}
\end{tcolorbox}
...
\begin{tcolorbox}[colback=defbox, colframe=defborder, arc=2pt,
  left=6pt, right=6pt, top=4pt, bottom=4pt,
  title={\small\textbf{Definition (Zero Vector in $\mathbf{F}^n$)}},
  fonttitle=\small\bfseries]
...
\begin{tcolorbox}[colback=defbox, colframe=defborder, arc=2pt,
  left=6pt, right=6pt, top=4pt, bottom=4pt,
  title={\small\textbf{Definition (Additive Inverse in $\mathbf{F}^n$)}},
  fonttitle=\small\bfseries]
...
\begin{tcolorbox}[colback=defbox, colframe=defborder, arc=2pt,
  left=6pt, right=6pt, top=4pt, bottom=4pt,
  title={\small\textbf{Definition (Scalar Multiplication in $\mathbf{F}^n$)}},
  fonttitle=\small\bfseries]
